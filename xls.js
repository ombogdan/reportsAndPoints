                  ...
                  switch (type) {
                      ...
                      case "fuelAnalytic":
                          ...
                          postData.params = {
                              date_start: $filter('date')(data.data.date_start * 1000, 'dd.MM.yyyy HH:mm:ss'),
                              date_end: $filter('date')(data.data.date_end * 1000, 'dd.MM.yyyy HH:mm:ss'),
                              distance_moving: $filter('number')(callScope.summByArray1(data.data.repData,'distance_moving'), 1),
                              fuel_used_moving: $filter('number')(callScope.summByArray1(data.data.repData,'fuel_used_moving'), 1),
                              processed: $filter('number')(callScope.summByArray1(data.data.repData,'processed'), 1),
                              fuel_used_processed: $filter('number')(callScope.summByArray1(data.data.repData,'fuel_used_processed'), 1),
                          }
